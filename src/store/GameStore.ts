...
export class GameStore {
  ...
  /**
   * Возвращает id символа типа "scatter" из конфига (например "SCATTER").
   * Нужен, чтобы подсветить разбросанные по полю скаттеры,
   * т.к. для них не приходит список позиций в win.lines.
   */
